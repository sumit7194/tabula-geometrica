...
WHAT THIS LICENSES. The instrument is demonstrated at degree 4 for a natural Hamiltonian (§171) and NOT
demonstrated at degree 4 for geodesic flow with several Killing vectors -- which is exactly the setting P3 lives
in. So §168\'s degree-4 refusals on bumped Kerr were CORRECT, and any degree-4 numerical null on a spacetime is
REFUSED rather than null, now for a measured reason with a named mechanism rather than as an open puzzle.
"""
