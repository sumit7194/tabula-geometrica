...
def main():
    ...
    # RECORD THE MODE. This file was stored from a --fast run and did not say so; re-running it faithfully in
    # full mode gives different numbers (n_train 80 -> 160, spread 0.285 -> 0.298) and reads as drift. It is
